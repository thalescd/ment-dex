...
fetch("https://raw.githubusercontent.com/ydarissep/dex-core/main/index.html")
    .then(async (response) => {
    ...
    .then(async (rawHTMLText) => {
        ...
        await fetch(
            "https://raw.githubusercontent.com/ydarissep/dex-core/main/src/global.js"
        )
            .then(async (response) => {
                return response.text();
            })
