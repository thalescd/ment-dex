...
window.onlyShowChangedPokemon = document.getElementById(
    "onlyShowChangedPokemon"
);
window.onlyShowStrategyPokemon = document.getElementById(
...
window.speciesPanelMainContainer = document.getElementById(
    "speciesPanelMainContainer"
);
window.speciesPanelHistoryContainer = document.getElementById(
...
window.speciesPanelInputSpecies = document.getElementById(
    "speciesPanelInputSpecies"
);
window.speciesPanelInputSpeciesDataList = document.getElementById(
...
window.speciesPanelLocationsButton = document.getElementById(
    "speciesPanelLocationsButton"
);
window.speciesPanelInfoButton = document.getElementById(
    "speciesPanelInfoButton"
);
window.speciesAbilities = document.getElementById("speciesAbilities");
window.speciesInnatesMainContainer = document.getElementById(
...
window.speciesChangesContainer = document.getElementById(
    "speciesChangesContainer"
);
window.speciesDefensiveTypeChart = document.getElementById(
    "speciesDefensiveTypeChart"
);
window.speciesOffensiveTypeChart = document.getElementById(
    "speciesOffensiveTypeChart"
);
window.speciesStrategiesContainer = document.getElementById(
    "speciesStrategiesContainer"
);
window.speciesStrategies = document.getElementById("speciesStrategies");
window.speciesPanelLevelUpFromPreviousEvoTable = document.getElementById(
    "speciesPanelLevelUpFromPreviousEvoTable"
);
window.speciesPanelLevelUpFromPreviousEvoTableTbody = document.getElementById(
    "speciesPanelLevelUpFromPreviousEvoTableTbody"
);
window.hideLevelUpFromPreviousEvolution = document.getElementById(
    "hideLevelUpFromPreviousEvolution"
);
window.speciesPanelLevelUpTable = document.getElementById(
    "speciesPanelLevelUpTable"
);
window.speciesPanelLevelUpTableTbody = document.getElementById(
...
window.speciesPanelTMHMTableTbody = document.getElementById(
    "speciesPanelTMHMTableTbody"
);
window.hideTMHM = document.getElementById("hideTMHM");
window.speciesPanelTutorTable = document.getElementById(
    "speciesPanelTutorTable"
);
window.speciesPanelTutorTableTbody = document.getElementById(
    "speciesPanelTutorTableTbody"
);
window.hideTutor = document.getElementById("hideTutor");
window.speciesPanelEggMovesTable = document.getElementById(
    "speciesPanelEggMovesTable"
);
window.speciesPanelEggMovesTableTbody = document.getElementById(
...
window.difficultyButtonContainer = document.getElementById(
...
window.abilitiesInputDataList = document.getElementById(
...
window.headerAbilitiesName = document.querySelector(
    "#abilitiesTableThead th.ability"
);
window.headerAbilitiesDescription = document.querySelector(
...
window.headerMovesAccuracy = document.querySelector(
...
window.headerSpeciesSprite = document.querySelector(
    "#speciesTableThead th.sprite"
);
window.headerSpeciesName = document.querySelector(
    "#speciesTableThead th.species"
);
window.headerSpeciesTypes = document.querySelector(
    "#speciesTableThead th.types"
);
window.headerSpeciesAbilities = document.querySelector(
    "#speciesTableThead th.abilities"
);
window.headerSpeciesInnates = document.querySelector(
    "#speciesTableThead th.innates"
);
window.headerSpeciesHP = document.querySelector("#speciesTableThead th.baseHP");
window.headerSpeciesAtk = document.querySelector(
    "#speciesTableThead th.baseAttack"
);
window.headerSpeciesDef = document.querySelector(
    "#speciesTableThead th.baseDefense"
);
window.headerSpeciesSpA = document.querySelector(
    "#speciesTableThead th.baseSpAttack"
);
window.headerSpeciesSpD = document.querySelector(
    "#speciesTableThead th.baseSpDefense"
);
window.headerSpeciesSpe = document.querySelector(
    "#speciesTableThead th.baseSpeed"
);
window.headerSpeciesBST = document.querySelector("#speciesTableThead th.BST");

window.headerLocationsSprite = document.querySelector(
    "#locationsTableThead th.sprite"
);
window.headerLocationsSpecies = document.querySelector(
    "#locationsTableThead th.species"
);
window.headerLocationsRarity = document.querySelector(
    "#locationsTableThead th.rarity"
);
window.headerLocationsZone = document.querySelector(
...
headerSpeciesInnates.addEventListener("click", () => {
    sortTableByClassName(
        ...
        ["innates"],
        "innates",
        (asc = headerSpeciesInnatestrue.classList.contains("th-sort-desc"))
    );
});
...
abilitiesInput.addEventListener("input", (e) => {
    ...
    typingTimer = setTimeout(function () {
        ...
        filterFilters(value);
        filterTableInput(value, abilities, [
            "name",
            "ingameName",
            "description",
        ]);
...
function tableIsTouching(entries) {
    if (
        ...
        tableInput.getBoundingClientRect().top <= 0
    ) {
        utilityButton.innerText = "☰";
    } else {
        if (table.getBoundingClientRect().top < 0) {
