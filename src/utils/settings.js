...
export function manageSettings() {
    ...
    speciesPanelFieldset.style.textAlign = "left";
    const speciesPanelLegend = document.createElement("legend");
    speciesPanelLegend.innerText = "Species Panel";
    speciesPanelFieldset.append(speciesPanelLegend);
    speciesPanelFieldset.append(
        returnSettingEl("speciesPanelHistoryHide", "Hide History")
    );
    speciesPanelFieldset.append(
        returnSettingEl("speciesPanelHistorySticky", "Sticky History")
    );
